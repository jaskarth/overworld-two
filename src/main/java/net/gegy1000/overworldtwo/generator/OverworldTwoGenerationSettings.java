...
public class OverworldTwoGenerationSettings {
	public static final Codec<OverworldTwoGenerationSettings> CODEC = RecordCodecBuilder.create(instance -> instance.group(
			ChunkGeneratorSettings.CODEC.fieldOf("type").forGetter(settings -> settings.wrapped),
	...
	public OverworldTwoGenerationSettings(ChunkGeneratorSettings wrapped, double surfaceLacunarity, double surfacePersistence, double tearLacunarity, double tearPersistence, double extraDensityScale, double extraDensityLacunarity, double extraDensityPersistence) {
