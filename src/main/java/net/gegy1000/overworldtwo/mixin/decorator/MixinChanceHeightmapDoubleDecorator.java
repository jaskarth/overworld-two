...
@Mixin(ChanceHeightmapDoubleDecorator.class)
public class MixinChanceHeightmapDoubleDecorator {
    private final DecoratorStream<ChanceDecoratorConfig> stream = new ChanceTopStream(Heightmap.Type.MOTION_BLOCKING, y -> y * 2);
