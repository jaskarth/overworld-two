...
@Mixin(CountHeightmapDoubleDecorator.class)
public class MixinCountHeightmapDoubleDecorator {
    private final DecoratorStream<CountDecoratorConfig> stream = new CountTopStream(Heightmap.Type.MOTION_BLOCKING, y -> y * 2);
